...
//		String sql = "SELECT pid, pname, pdescription, image_url, stock, unitprice, category FROM Product WHERE pid = ?";
//
//		return jdbcTemplate.queryForObject(sql, new Object[] { id }, (rs, rowNum) -> {
//			return new Product(rs.getString("image_url"), rs.getString("pname"),
//					rs.getBigDecimal("unitprice").doubleValue(), rs.getInt("stock"), rs.getString("category"),
//					rs.getString("pdescription"));
//		});
//	}
//
